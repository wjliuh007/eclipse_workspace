...
public class GtOrdersNew extends BaseEntity implements java.io.Serializable{
	...
	private java.lang.Long actualAmount;
    /**
	...
	private ButtonStatus buttonDisplayStatus;
	...
	public ButtonStatus getButtonDisplayStatus() {
		return buttonDisplayStatus;
	}

	public void setButtonDisplayStatus(ButtonStatus buttonDisplayStatus) {
	...
	public java.lang.Long getActualAmount() {
		return actualAmount;
	}

	public void setActualAmount(java.lang.Long actualAmount) {
	...
	public Map<String,Object> getResult(){
		...
		result.put("actualAmount", this.getActualAmount());
		result.put("buttonDisplayStatus", this.getButtonDisplayStatus());
		result.put("imgList", this.getImgList());
		result.put("isThesea", this.getIsThesea());
		return result;
	}
}
