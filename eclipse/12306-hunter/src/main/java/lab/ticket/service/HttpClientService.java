...
public class HttpClientService {
	...
	// 获取登录提交的随机数
	public static final String POST_UTL_LOGINACTION_LOGINAYSNSUGGEST = "https://kyfw.12306.cn/otn/login/init";
	// 登录
	public static final String POST_UTL_LOGINACTION = "https://kyfw.12306.cn/otn/login/init";
	// 获取TOKEN URL
	public static final String GET_URL_USERTOKEN = "https://kyfw.12306.cn/otn/login/init";
	// 查询余票URL
	...
	// 获取验证码(登录)
	public static final String GET_LOGINURL_PASSCODE = "https://kyfw.12306.cn/otn/passcodeNew/getPassCodeNew?module=login&rand=sjrand&";
	// 获取验证码(提交订单)
	public static final String GET_SUBMITURL_PASSCODE = "https://kyfw.12306.cn/otn/passcodeNew/getPassCodeNew?module=passenger&rand=randp&";
	...
	public Map<String, String> initCookie() {
		...
		try {
			...
			HttpResponse response = getHttpRequest(httpClient, "https://kyfw.12306.cn/otn/login/init", null, null);
			// 获取消息头的信息
	...
	public static final String MTA1MTAX = "MTA1MTAx";
